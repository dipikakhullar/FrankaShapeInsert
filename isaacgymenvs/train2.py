...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    from isaacgymenvs.learning import insert_player
    import isaacgymenvs
    ...
    print("*********************")
    # print(f"CONFIG Batch size: {cfg.train.params.batch_size}")
    print(f"CONFIG Minibatch size: {cfg.train.params.minibatch_size}")
    # print(f"Train config batch size: {cfg.train.params.batch_size}, minibatch size: {cfg.train.params.minibatch_size}")

    # print(f"Batch size: {cfg_dict['train']['params']['batch_size']}")
    print(f"Minibatch size: {cfg_dict['train']['params']['minibatch_size']}")
    print("*********************")
    ...
    def build_runner(algo_observer):
        ...
        runner.player_factory.register_builder('a2c_continuous', lambda **kwargs : insert_player.InsertPlayer(**kwargs))
        return runner
